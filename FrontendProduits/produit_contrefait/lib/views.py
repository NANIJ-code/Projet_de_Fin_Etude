...
class UniteProduitViewSet(viewsets.ModelViewSet):
    ...
    def lancer_alerte(self, request, pk=None):
        ...
        if destinataire is None:
            return Response(
                {"detail": "Aucun destinataire trouvé pour cette alerte. Veuillez contacter un administrateur."},
            ...
            try:
                ...
                serializer = AlerteInconnueSerializer(
                    ...
                    context={
                        ...
                        'destinataire': destinataire_objet,  # à définir selon ta logique
                    }
                )
...
class AlerteViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Alerte.objects.filter(
            Q(emetteur=user) | Q(destinataire=user)
