...
class UtilisateurSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Utilisateur
        fields = ['id','username', 'first_name', 'email' ,'telephone', 'pays', 'ville', 'adresse', 'role']
        read_only_fields = ['role','username','email']  # Empêche la modification du rôle lors de la mise à jour
