...
git checkout main
# Travaille/modifie dans BackendProduits/
git add BackendProduits/
git commit -m "Modifications backend"
git push origin main

git checkout main
git pull origin main
# Seul BackendProduits/ sera modifié si tu n’as changé que ce dossier sur main


git checkout frontend
# Travaille/modifie dans FrontendProduits/
git add FrontendProduits/
git commit -m "Modifications frontend"
